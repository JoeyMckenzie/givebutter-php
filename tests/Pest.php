...
expect()->extend('toBeTransaction', fn () => $this->toBeInstanceOf(GetTransactionResponse::class)
    ->id->toBeString()
    ->number->toBeString()
    ->campaignId->toBeInt()
    ...
    ->createdAt->toBeInstanceOf(CarbonImmutable::class)
    ->timezone->toBeString()
    ->givingSpace->toBeInstanceOf(GivingSpaceResponse::class)
    ->dedication->toBeInstanceOf(DedicationResponse::class)
    ->transactions->toBeArray()->each->toBeInstanceOf(TransactionResponse::class)
    ->customFields->toBeArray()->each->toBeInstanceOf(CustomFieldResponse::class)
    ->utmParameters->toBeArray()
    ->externalId->toBeString()
    ->communicationOptIn->toBeBool()
    ->sessionId->toBeString()
    ->attributionData->toBeArray()
    ->fairMarketValueAmount->toBeInt()
    ->taxDeductibleAmount->toBeInt()
    ->message->toBeNull()
    ->errors->toBeNull());

expect()->extend('toBeTransactionWithErrors', fn () => $this->toBeInstanceOf(GetTransactionResponse::class)
    ->id->toBeNull()
    ->number->toBeNull()
    ->campaignId->toBeNull()
    ->campaignCode->toBeNull()
    ->planId->toBeNull()
    ->pledgeId->toBeNull()
    ->teamId->toBeNull()
    ->memberId->toBeNull()
    ...
    ->payout->toBeNull()
    ->currency->toBeNull()
    ->transactedAt->toBeNull()
    ->createdAt->toBeNull()
    ->timezone->toBeNull()
    ->givingSpace->toBeNull()
    ->dedication->toBeNull()
    ->transactions->toBeNull()
    ->customFields->toBeNull()
    ->utmParameters->toBeNull()
    ->externalId->toBeNull()
    ->communicationOptIn->toBeNull()
    ->sessionId->toBeNull()
    ->attributionData->toBeNull()
    ->fairMarketValueAmount->toBeNull()
    ->taxDeductibleAmount->toBeNull()
    ->message->toBeString()->not->toBeEmpty()
    ->errors->toBeArray()->not->toBeEmpty());
